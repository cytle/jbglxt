...
return array(
    ...
    'TMPL_PARSE_STRING' => array(
        '__STATIC__' => __ROOT__ . '/Public/' . MODULE_NAME . '/' . THEME . '/static',
        '__IMG__'    => __ROOT__ . '/Public/' . MODULE_NAME . '/' . THEME . '/images',
        '__CSS__'    => __ROOT__ . '/Public/' . MODULE_NAME . '/' . THEME . '/css',
        '__JS__'     => __ROOT__ . '/Public/' . MODULE_NAME . '/' . THEME . '/js',
    ),
